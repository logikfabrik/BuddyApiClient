namespace BuddyApiClient.Test.PermissionSets
{
    ...
    public sealed class PermissionSetsClientTest
    {
        ...
        {
            [Theory]
            [FileData(@"PermissionSets/.testdata/Create_Should_Create_And_Return_The_Permission_Set.json")]
            public async Task Should_Create_And_Return_The_Permission_Set(string responseJson)
            {
        ...
        {
            [Theory]
            [FileData(@"PermissionSets/.testdata/Get_Should_Return_The_Permission_Set_If_It_Exists.json")]
            public async Task Should_Return_The_Permission_Set_If_It_Exists(string responseJson)
            {
                var handlerStub = new MockHttpMessageHandler();
            ...
            [Fact]
            public async Task Should_Throw_If_The_Permission_Set_Does_Not_Exist()
            {
                var handlerStub = new MockHttpMessageHandler();
        ...
        {
            [Theory]
            [FileData(@"PermissionSets/.testdata/List_Should_Return_Permission_Sets_If_Any_Exists.json")]
            public async Task Should_Return_Permission_Sets_If_Any_Exists(string responseJson)
            {
                var handlerStub = new MockHttpMessageHandler();
            ...
            [Theory]
            [FileData(@"PermissionSets/.testdata/List_Should_Not_Return_Permission_Sets_If_None_Exist.json")]
            public async Task Should_Not_Return_Permission_Sets_If_None_Exist(string responseJson)
            {
                var handlerStub = new MockHttpMessageHandler();
