namespace BuddyApiClient.Test.ProjectMembers
{
    ...
    public sealed class ProjectMembersClientTest
    {
        ...
        {
            return new ProjectMembersClient(new Lazy<HttpClientFacade>(HttpClientFacadeFactory.Create(new Uri("https://api.buddy.works"), string.Empty, handler.ToHttpClient())));
        }
