namespace BuddyApiClient.Test.ProjectGroups
{
    ...
    public sealed class ProjectGroupsClientTest
    {
        ...
        {
            return new ProjectGroupsClient(new Lazy<HttpClientFacade>(HttpClientFacadeFactory.Create(string.Empty, handler.ToHttpClient(), new Uri("https://api.buddy.works"))));
        }
